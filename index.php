...
<body>
    ...
    $target_file = $upload_directory . basename($_FILES["image"]["name"]);
    ...
    <section class="container">
        ...
        <p>Anda bisa memberikan review untuk web ini dengan cara mengisi form dibawah ini :</p>
